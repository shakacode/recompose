...
const getDisplayName = function getDisplayName(Component$$1) {
...
const identity = function identity(Component$$1) {
  return Component$$1
}
...
const renderComponent = function renderComponent(Component$$1) {
  return function(_) {
    const factory = createFactory(Component$$1)
...
const isClassComponent = function isClassComponent(Component$$1) {
  return Boolean(
    Component$$1 &&
...
const componentFromProp = function componentFromProp(propName) {
  const Component$$1 = function Component$$1(props) {
